                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3">
                                        <?php
                                            $sql = "SELECT COUNT(*) AS total FROM print_request where shop_id=$shop_id;";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3">
                                        <?php
                                            $sql = "SELECT count(id) as total FROM print_request where shop_id=$shop_id AND is_done=0;";
                                            $result = mysqli_query($conn, $sql);
                                            $row = mysqli_fetch_assoc($result);
                                            echo $row["total"];
                                        ?>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3">
                                        <?php
                                            $sql = "SELECT quantity, color_scheme FROM print_request where shop_id=$shop_id;";
                                            $result = mysqli_query($conn, $sql);
                                            $total_earning = 0;
